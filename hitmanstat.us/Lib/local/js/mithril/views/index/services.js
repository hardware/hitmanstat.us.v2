...
services.view = function () {
    return [
        ...
        setElusivesGroup(services)
    ]
};

function setElusivesGroup(services) {
    return m("div", { class: setCardDeckClasses("elusives") }, services.list.map(function (service) {
        if (service.ref === "h3steam") {
            if (service.elusives) {
                return service.elusives.map(function (elusive) {
                    if (elusive.name) {
                        if (elusive.name === "placeholder") {
                            return [
                                m("div", { class: "card" }, [
                                    m("div", { class: "card-img-wrap" }, [
                                        m("img", { class: "card-img-top", src: elusive.tile, alt: "next target", "asp-append-version": "true" })
                                    ]),
                                    m("div", { class: "card-body card-body-misc" }, [
                                        m("a", { class: "misc-link" }, "Awaiting next target")
                                    ])
                                ])
                            ]
                        } else {
                            return [
                                m("div", { class: "card" }, [
                                    m("a", {
                                        role: "button",
                                        "data-toggle": "modal",
                                        "data-target": "#elusive_" + elusive.name.hashCode()
                                    }, [
                                        m("div", { class: "card-img-wrap" }, [
                                            setElusiveStatus(elusive),
                                            m("img", { class: "card-img-top", src: elusive.tile, alt: elusive.name })
                                        ]),
                                    ]),
                                    m("div", { class: "card-body card-body-misc elusive-body" }, [
                                        m("a", {
                                            class: "misc-link",
                                            role: "button",
                                            "data-toggle": "modal",
                ...
                return [
                    m("div", { class: "card" }, [
                        m("div", { class: "card-body" }, [
                            m("div", { class: "text-center text-muted" }, "No elusive targets planned at this time.")
                        ])
                    ])
                ]
            }
...
function setCardTitle(service) {
    if (service.name.indexOf("1 pc") !== -1) {
...
function setElusiveStatus(elusive) {
    var start = moment(elusive.nextWindow.start);
    if (moment().isAfter(start)) {
        return m("div", { class: "ribbon ribbon-top-left" }, [
            m("span", "Active")
        ])
    }
}
...
function setElusiveModal(elusive) {
    var modalId = "elusive_" + elusive.name.hashCode();
    var start = moment(elusive.nextWindow.start);
    var end = moment(elusive.nextWindow.end);
        ...
        m("div", { class: "modal-dialog modal-dialog-centered modal-lg", role: "document" },
            m("div", { class: "modal-content" }, [
                m("div", { class: "modal-header" }, [
                    m("h5", { class: "modal-title" }, elusive.name),
                ...
                m("div", { class: "modal-body" }, [
                    ...
                    }, m.trust(elusive.description)),
                    m("table", { class: "table" }, [
                        m("tr", [m("th", "Name"), m("td", elusive.name)]),
                        m("tr", [m("th", "Location"), m("td", elusive.location)]),
